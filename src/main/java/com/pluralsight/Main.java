...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            ...
            if (input == 1) {
                useMortgageCalculator(scanner);
            } else if (input == 2) {
                useCDValueCalculator(scanner);
            } else if (input == 3) {
                useAnnuityCalculator(scanner);
            } else if (input == 4) {
    ...
    public static void useAnnuityCalculator(Scanner scanner) {
    ...
    private static void useCDValueCalculator(Scanner scanner) {
    ...
    private static void useMortgageCalculator(Scanner scanner) {
